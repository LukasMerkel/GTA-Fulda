...
//Name: C5.ma
//Last modified: Sun, Dec 07, 2014 09:44:57 PM
//Codeset: 1252
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -28.035788378770487 155.26891301609584 -2.9385614076050004 ;
	setAttr ".r" -type "double3" -68.400000000002635 -60.399999999998265 0 ;
	setAttr ".rpt" -type "double3" 6.7968671366236733e-014 -6.8130985224940849e-014 
		1.1003402050422713e-014 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999964;
	setAttr ".coi" 195.96256506384228;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" 65.240926722322214 0.21288918578859217 8.4242020028138214 ;
	setAttr ".hc" -type "string" "viewSet -p %camera";
createNode transform -s -n "top";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 47.478706961014737 137.12685879855172 11.258923252710945 ;
	setAttr ".r" -type "double3" -89.999999999999986 0 0 ;
createNode camera -s -n "topShape" -p "top";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 100.1;
	setAttr ".ow" 6.7467187543337301;
...
createNode transform -s -n "front";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 47.474934743673955 1.3435599047870932 139.84537711181417 ;
createNode camera -s -n "frontShape" -p "front";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 100.1;
	setAttr ".ow" 1.4827688055809158;
...
createNode transform -s -n "side";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 103.12969305987096 1.489138272765159 6.070012159550835 ;
	setAttr ".r" -type "double3" 0 89.999999999999986 0 ;
createNode camera -s -n "sideShape" -p "side";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 100.1;
	setAttr ".ow" 31.592993087334388;
...
createNode transform -n "pointLight1";
	setAttr ".t" -type "double3" -11.837246576746765 30.089054179744601 -0.024375778467714326 ;
...
createNode transform -n "pointLight4";
	setAttr ".t" -type "double3" 57.08021792666095 30.089054179744601 -1.5278624688708555 ;
...
createNode camera -n "cameraShape1" -p "camera1";
	...
	setAttr ".ff" 0;
	setAttr ".fd" 0.8971670692192818;
	setAttr ".coi" 1.317878020014307;
	setAttr ".ow" 30;
...
createNode transform -n "camera5" -p "carRNfosterParent1";
	setAttr ".t" -type "double3" -33.857439444863402 7.5863189332403298 -1.1383176621398823 ;
...
createNode camera -n "cameraShape5" -p "camera5";
	...
	setAttr ".cap" -type "double2" 1.41732 0.94488 ;
	setAttr ".ff" 0;
	setAttr ".coi" 14.587359353860915;
	setAttr ".ow" 30;
...
createNode reference -n "man_orangeRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		2 "|man_orange:complete" "translate" " -type \"double3\" 46.57402 0.0552411 11.651519"
		
		2 "|man_orange:complete" "translateX" " -av"
		2 "|man_orange:complete" "translateY" " -av"
		2 "|man_orange:complete" "translateZ" " -av"
		2 "|man_orange:complete" "rotate" " -type \"double3\" 0 1.071859 0"
		...
		2 "|man_orange:lieder" "translate" " -type \"double3\" 46.571101 0.0316515 11.60507"
		
		2 "|man_orange:lieder" "translateY" " -av"
		2 "|man_orange:lieder" "rotate" " -type \"double3\" -86.343029 1.071859 -2.805658"
...
createNode reference -n "carRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		2 "|car:complete" "translate" " -type \"double3\" 54.895081 0.0978067 5.10449"
		
		2 "|car:complete" "translateX" " -av"
		2 "|car:complete" "translateY" " -av"
		2 "|car:complete" "translateZ" " -av"
		2 "|car:complete" "rotate" " -type \"double3\" 0 -179.545029 0"
...
createNode reference -n "police_blueRN";
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"police_blueRN" 0
		"police_blueRN" 2
		2 "|police_blue:complete" "translate" " -type \"double3\" -36.630613 1.113751 61.60533"
...
createNode reference -n "police_redRN";
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"police_redRN" 0
		"police_redRN" 2
		2 "|police_red:complete" "translate" " -type \"double3\" -39.747168 1.114 53.294567"
...
createNode reference -n "tankRN";
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"tankRN" 0
		"tankRN" 4
		2 "|tank:ball" "translate" " -type \"double3\" -39.768657 4.144796 49.727799"
		
		2 "|tank:ball" "rotate" " -type \"double3\" 0 0 0"
		2 "|tank:complete" "translate" " -type \"double3\" -34.88923 0.528192 42.890471"
...
createNode reference -n "womanRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"womanRN" 0
		"womanRN" 36
		2 "|woman:complete" "translate" " -type \"double3\" 42.866515 -1.52934 11.201071"
		
		2 "|woman:complete" "translateX" " -av"
		2 "|woman:complete" "translateY" " -av"
		2 "|woman:complete" "rotate" " -type \"double3\" -21.417886 11.920661 27.77073"
...
createNode reference -n "man_greenRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"man_greenRN" 0
		"man_greenRN" 4
		2 "|man_green:complete" "rotate" " -type \"double3\" 0 -89.126125 0"
...
createNode reference -n "planeRN";
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"planeRN" 0
		"planeRN" 1
		2 "|plane:complete" "translate" " -type \"double3\" -36.732299 6.52077 53.893738";
	setAttr ".ptag" -type "string" "";
lockNode -l 1 ;
...
createNode reference -n "policeRN";
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"policeRN" 0
		"policeRN" 1
		2 "|police:complete" "translate" " -type \"double3\" 0 1.242178 0";
	setAttr ".ptag" -type "string" "";
lockNode -l 1 ;
...
createNode animCurveTL -n "complete_translateX";
	...
	setAttr -s 25 ".ktv[0:24]"  1 54.89508109608267 148 54.772119353269005
		 ...
		 633 -24.542041672871065 634 -22.889416151929634 750 54.19547716450198 755 57.742189386900307
...
createNode animCurveTL -n "complete_translateZ";
	...
	setAttr -s 25 ".ktv[0:24]"  1 5.1044899643141015 148 5.1044899643141015
		 ...
		 757 -2.9203000923645899 760 -0.43961630269413643 800 32.373473668543582;
createNode animCurveTA -n "complete_rotateX";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 20 ".ktv[0:19]"  220 0 555 0 557 0 560 0 562 0 563 0 565 0
		 567 0 620 0 621 174.27572940236689 623 173.45274515500626 625 169.17802281430727
		 627 117.96560129986305 630 2.3099977419798874 633 1.2330483951838043 634 1.2071709802458064
		 751 1.2991169225457453 755 1.7772094041238948 757 3.5842345435996377 760 -99.847876575465904;
createNode animCurveTA -n "complete_rotateY";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 20 ".ktv[0:19]"  220 -179.54502945645424 555 -179.54502945645424
		 557 -191.66223149531498 560 -177.87296623512086 562 -163.89491498037037 563 -163.90723799582616
		 565 -184.72676829594729 567 -178.88477277804245 620 -177.87296623512086 621 -3.4534773531002982
		 623 29.171915797333863 625 57.977148374777443 627 83.527700175620723 630 58.491801863082188
		 633 -11.793730308855718 634 -0.92231470530388504 751 -21.702760794958884 755 -47.217161784649008
		 757 -70.308755055799665 760 -91.225068225816955;
createNode animCurveTA -n "complete_rotateZ";
	...
	setAttr -s 20 ".ktv[0:19]"  220 0 555 0 557 0 560 0 562 0 563 0 565 0
		 ...
		 627 117.63631623189688 630 2.7144299644162286 633 0.49265565449617466 634 0.72528000872581089
		 751 0.26424088267809825 755 -0.55983185035596528 757 -2.6304209712492472 760 100.59479836554367;
...
createNode animCurveTL -n "complete_translateY1";
	...
	setAttr -s 13 ".ktv[0:12]"  1 0.055241100000000001 150 0.055241100000000001
		 ...
		 291 0.059969849578862533 308 0.059969849578862533 310 -0.36576122030180169;
...
createNode animCurveTL -n "complete_translateX2";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  1 42.86651476746632 290 42.86651476746632
...
createNode animCurveTL -n "complete_translateY2";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  1 -1.5293395064864579 290 -1.529 291 0.15859655638663497
		 297 1.0452462452141746 304 1.543461443461269 310 0.54015168892211851;
createNode animCurveTL -n "complete_translateZ2";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  1 11.201071450833858 290 11.201071450833858
...
createNode animCurveTL -n "complete_translateX3";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 -41.460524162305461;
createNode animCurveTL -n "complete_translateY3";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 0.42338196361272695;
createNode animCurveTL -n "complete_translateZ3";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 1.9375018637796553;
select -ne :time1;
	setAttr ".o" 1;
	setAttr ".unw" 1;
