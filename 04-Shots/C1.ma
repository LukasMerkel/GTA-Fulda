...
//Name: C1.ma
//Last modified: Sun, Dec 07, 2014 07:33:55 PM
//Codeset: 1252
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 64.223346302106037 65.761654188420806 -10.931116712476783 ;
	setAttr ".r" -type "double3" -67.79999999999248 140.39999999999807 0 ;
	setAttr ".rpt" -type "double3" 5.9449696349773194e-014 -6.419937893224317e-014 1.3156907904748014e-014 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999964;
	setAttr ".coi" 69.524461066092869;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" 47.478742645233901 1.3910007625625997 9.3096320985920133 ;
...
createNode transform -n "pointLight4";
	setAttr ".t" -type "double3" 57.08021792666095 30.089054179744601 -1.5278624688708557 ;
...
createNode camera -n "cameraShape1" -p "camera1";
	...
	setAttr ".ff" 0;
	setAttr ".fd" 5.9891540670452859;
	setAttr ".coi" 6.4098650297502671;
	setAttr ".ow" 30;
...
createNode reference -n "man_orangeRN";
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		2 "|man_orange:lieder" "translate" " -type \"double3\" 46.57402 0.0552411 11.651519"
		
		2 "|man_orange:lieder" "rotate" " -type \"double3\" 0 1.071859 0";
	setAttr ".ptag" -type "string" "";
lockNode -l 1 ;
