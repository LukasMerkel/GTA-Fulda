...
//Name: C2.ma
//Last modified: Sun, Dec 07, 2014 08:18:10 PM
//Codeset: 1252
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 38.662898407468184 10.022261110468824 6.1643878051331971 ;
	setAttr ".r" -type "double3" -37.19999999999952 -131.59999999999943 0 ;
	setAttr ".rpt" -type "double3" 6.8452008923961267e-014 -6.6048101688353173e-014 
		1.1609029249462363e-014 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999964;
	setAttr ".coi" 11.813266817125152;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" 43.564069412109951 0.88302978935282894 10.500622528219029 ;
...
createNode lookAt -n "camera2_group";
	...
	setAttr ".tws" -1.2074182697257333e-006;
...
createNode reference -n "man_orangeRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		""
		5 4 "man_orangeRN" "|man_orange:lieder.translateX" "man_orangeRN.placeHolderList[4]" 
		""
		5 4 "man_orangeRN" "|man_orange:lieder.translateY" "man_orangeRN.placeHolderList[5]" 
		""
		5 4 "man_orangeRN" "|man_orange:lieder.translateZ" "man_orangeRN.placeHolderList[6]" 
		""
		5 4 "man_orangeRN" "|man_orange:lieder.rotateX" "man_orangeRN.placeHolderList[7]" 
		""
		5 4 "man_orangeRN" "|man_orange:lieder.rotateY" "man_orangeRN.placeHolderList[8]" 
		""
		5 4 "man_orangeRN" "|man_orange:lieder.rotateZ" "man_orangeRN.placeHolderList[9]" 
		"";
	setAttr ".ptag" -type "string" "";
lockNode -l 1 ;
...
createNode reference -n "womanRN";
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"womanRN" 0
		"womanRN" 1
		2 "|woman:complete" "translate" " -type \"double3\" -27.798358 0.059503 23.326187";
	setAttr ".ptag" -type "string" "";
lockNode -l 1 ;
createNode reference -n "man_greenRN";
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"man_greenRN" 0
		"man_greenRN" 2
		2 "|man_green:complete" "translate" " -type \"double3\" -27.268789 0.0541284 21.805944"
...
createNode animCurveTL -n "complete_translateX";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  1 54.89508109608267 148 54.772119353269005
		 153 50.82540007402735 190 42.200731601162865 220 38.908648828684342;
createNode animCurveTL -n "complete_translateY";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  1 0.097806717224004747 148 0.097806717224004747
		 153 0.097806717224004747 190 0.097806717224004747 220 0.097806717224004747;
createNode animCurveTL -n "complete_translateZ";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  1 5.1044899643141015 148 5.1044899643141015
		 153 5.1044899643141015 190 7.7722986546497825 220 7.7722986546497825;
...
createNode animCurveTA -n "complete_rotateY";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  220 -179.54502945645424;
...
createNode animCurveTL -n "complete_translateX1";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  1 46.57402 150 46.57402 151 46.57402 220 46.57402
		 221 46.57402;
createNode animCurveTL -n "complete_translateY1";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  1 0.055241100000000001 150 0.055241100000000001
		 151 -1.3801131739142218 220 -1.3801131739142218 221 0.059969849578862533;
createNode animCurveTL -n "complete_translateZ1";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  1 11.651519 150 11.651519 151 11.651519
		 220 11.651519 221 11.651519;
...
connectAttr "lieder_translateX.o" "man_orangeRN.phl[4]";
connectAttr "lieder_translateY.o" "man_orangeRN.phl[5]";
connectAttr "lieder_translateZ.o" "man_orangeRN.phl[6]";
connectAttr "lieder_rotateX.o" "man_orangeRN.phl[7]";
connectAttr "lieder_rotateY.o" "man_orangeRN.phl[8]";
connectAttr "lieder_rotateZ.o" "man_orangeRN.phl[9]";
