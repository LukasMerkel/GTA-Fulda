...
//Name: C9.ma
//Last modified: Mon, Dec 08, 2014 01:49:57 PM
//Codeset: 1252
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 58.365719184553505 18.446150921960747 -17.636509655068934 ;
	setAttr ".r" -type "double3" -17.400000000022732 183.99999999999824 0 ;
	setAttr ".rp" -type "double3" -7.1054273576010019e-015 0 0 ;
	setAttr ".rpt" -type "double3" 5.219825929798101e-014 -7.99097080040748e-014 1.8402942367832476e-014 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".fl" 34.999999999999964;
	setAttr ".coi" 50.476629272734655;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" 50.703521198911311 4.2348136114796393 30.67144590121233 ;
...
createNode lookAt -n "camera1_group";
	...
	setAttr ".db" 1.8425870808555729;
createNode transform -n "camera1" -p "camera1_group";
createNode camera -n "cameraShape1" -p "camera1";
	setAttr -k off ".v";
	setAttr ".cap" -type "double2" 1.41732 0.94488 ;
	setAttr ".ff" 0;
	setAttr ".fd" 1.4218761248910881;
	setAttr ".coi" 1.8425870808555729;
	setAttr ".ow" 30;
...
createNode transform -n "camera9_aim" -p "tankRNfosterParent1";
	setAttr ".t" -type "double3" -4.7769354238030921 3.2468501791659046 3.0602325166866819 ;
	setAttr ".r" -type "double3" 0 89.999999999999986 0 ;
	setAttr ".drp" yes;
...
createNode reference -n "man_orangeRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		2 "|man_orange:lieder" "rotate" " -type \"double3\" -15.725702 1.071859 -2.805658"
...
createNode reference -n "carRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		2 "|car:complete" "translate" " -type \"double3\" 54.894137 0.0978067 5.10449"
...
createNode reference -n "tankRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		2 "|tank:ball" "translate" " -type \"double3\" 62.556797 4.066982 25.887687"
		...
		2 "|tank:complete" "translate" " -type \"double3\" 62.765358 0.433926 34.081365"
...
createNode reference -n "womanRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"womanRN" 0
		"womanRN" 36
		2 "|woman:complete" "translate" " -type \"double3\" 42.866515 -1.529339 11.201071"
...
createNode reference -n "planeRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		2 "|plane:complete" "translate" " -type \"double3\" 62.093931 14.459618 15.715321"
